...
import ee.bpw.dhx.ws.service.impl.container_2_1.DocumentServiceImpl2_1;
...
@Service
@Slf4j
public class DocumentClientService extends DocumentServiceImpl2_1{
	...
	/***Implementation of abtract method. Searches if that consignment id and that member are in the list of saved documents */
	@Override
