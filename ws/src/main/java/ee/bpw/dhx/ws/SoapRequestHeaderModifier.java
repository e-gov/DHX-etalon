...
public class SoapRequestHeaderModifier implements WebServiceMessageCallback {
  ...
  public SoapRequestHeaderModifier(InternalXroadMember service, InternalXroadMember client,
      String serviceName,
    ...
    dhxMarshallerService = (DhxMarshallerService) AppContext.getApplicationContext().getBean("dhxMarshallerService");
  }
  ...
  public void doWithMessage(WebServiceMessage message) throws IOException, TransformerException {
    try {
      ...
      transformer.transform(
          marshallObject(factory.createProtocolVersion(protocolVersion)),
          header.getResult());
      transformer.transform(
