package ee.bpw.dhx.ws.service.impl.container_2_1;
...
/**
 * Implementation of document service specific for container version 2.1. Extends generis DocumentService implementation. 
 * Uses containers specific for capsule version 2.1
 * @author Aleksei Kokarev
 *
 */

@Slf4j
public abstract class DocumentServiceImpl2_1 extends DocumentServiceImpl{
	...
	/**
	 * 
	 * @param container - container which needs to be sent. container will be sent to each recipient defined in container
	...
	protected List<SendDocumentResponse> sendDocument(DecContainer container, String consignmentId) throws DhxException{
		...
		if(container != null && container.getTransport() != null 
	        ...
	        for (DecRecipient recipient : container.getTransport().getDecRecipient()) {	
	        	...
	        	DhxDocument document = new DhxDocument2_1(adressee, /*recipient.getOrganisationCode(),*/ container, capsuleFile, true);
	...
	/**
	 * Method extracts and validates capsule. Uses capsuleXsdFile21 configuration parameter for find XSD against which to validate
	...
	protected DhxDocument extractAndValidateDocument(SendDocument document, XroadMember client) throws DhxException {
		try{
			...
			super.checkRecipient(document.getRecipient(), getStringList(container.getTransport().getDecRecipient()));
			...
			DhxDocument2_1 dhxDocument = new DhxDocument2_1(client, document, container);
			return dhxDocument;
	...
	public String recieveDocument (DhxDocument document) throws DhxException {
		if(document instanceof DhxDocument2_1) {
			return recieveDocument2_1((DhxDocument2_1)document);
		} else {
			throw new DhxException(DHXExceptionEnum.WS_ERROR, "Wrong type of document. Expected version 2.1");
		}
	}
	
	/**
	 * Function receives document of version 2.1 and returns unique id of it. Id will be sent as receipt in response
	 * @param document - document to receive
	 * @return - unique id of the document that was saved. 
	 * @throws DhxException
	 */
	public abstract String recieveDocument2_1 (DhxDocument2_1 document) throws DhxException;
