...
public class OutgoingDhxPackage extends DhxPackage {
  ...
  public OutgoingDhxPackage(InternalXroadMember service, InternalXroadMember client,
      ...
      CapsuleVersionEnum parsedContainerVersion, File file, String internalConsignmentId, String dhxProtocolVersion)
      throws DhxException {
  ...
  public OutgoingDhxPackage(InternalXroadMember service, InternalXroadMember client,
      InputStream stream,
      Object parsedContainer,
      CapsuleVersionEnum parsedContainerVersion, String internalConsignmentId, String dhxProtocolVersion)
      throws DhxException {
