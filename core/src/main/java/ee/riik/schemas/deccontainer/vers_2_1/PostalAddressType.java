...
@XmlType(name = "PostalAddressType", propOrder = {"country", "county", "localGovernment",
    "administrativeUnit", "smallPlace", "landUnit", "street", "houseNumber",
    "buildingPartNumber", "postalCode"})
