...
@XmlType(name = "XRoadIdentifierType", propOrder = {"xRoadInstance", "memberClass", "memberCode",
    "subsystemCode", "groupCode", "serviceCode", "serviceVersion", "securityCategoryCode",
    "serverCode"})
@XmlSeeAlso({XRoadCentralServiceIdentifierType.class, XRoadServiceIdentifierType.class,
    XRoadClientIdentifierType.class, XRoadGlobalGroupIdentifierType.class,
    XRoadLocalGroupIdentifierType.class, XRoadSecurityCategoryIdentifierType.class,
